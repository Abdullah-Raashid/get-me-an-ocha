  ...
  return (
    <div className="container mx-auto px-8 md:px-4 py-8">
      ...
      <p className="text-lg mb-6">
        Get Me an Ocha is a crowdfunding platform designed for creators to fund
        ...
        you an ocha. Unlock the potential of your fanbase and bring your
        projects to life.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p>
              Receive support from your fans in the form of ocha purchases,
